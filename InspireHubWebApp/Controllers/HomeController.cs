...
namespace InspireHubWebApp.Controllers
{
    public class HomeController : Controller
    {
        ...
        //    await _emailService.SendMessageAsync(template1.Subject, "kukadion1@gmail.com", template1.Body, null);
